...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='word',
            index=models.Index(fields=['id'], name='words_word_id_128a62_idx'),
        ),
        migrations.AddIndex(
            model_name='word',
        ...
        migrations.AddIndex(
            model_name='word',
            index=models.Index(fields=['rank_lyric'], name='words_word_rank_ly_9ddeb3_idx'),
        ),
        migrations.AddIndex(
            model_name='word',
            index=models.Index(fields=['rank_rss_feed'], name='words_word_rank_rs_f578a5_idx'),
        ),
        migrations.AddIndex(
            model_name='word',
            index=models.Index(fields=['rank_subtitle'], name='words_word_rank_su_2c59ea_idx'),
        ),
        migrations.AddIndex(
            model_name='word',
            index=models.Index(fields=['rank_wikipedia'], name='words_word_rank_wi_026a5f_idx'),
        ),
